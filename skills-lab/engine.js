...
export class Simulation {
 ...
 export(){return {version:VERSION,scenario:this.s.scenario,mode:this.s.mode,attempt:this.s.attempt,completed:this.s.complete,omitted:this.omissions().map(k=>({key:k,label:required[k]})),assisted:this.s.assisted,events:this.s.log};}
}
